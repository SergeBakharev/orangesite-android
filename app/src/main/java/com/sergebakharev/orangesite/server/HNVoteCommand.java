package com.sergebakharev.orangesite.server;
...
public class HNVoteCommand extends NoResponseCommand {
    ...
    public HNVoteCommand(String url, HashMap<String, String> queryParams, com.sergebakharev.orangesite.server.IAPICommand.RequestType type,
