package com.sergebakharev.orangesite.login;
...
import com.sergebakharev.orangesite.R;
import com.sergebakharev.orangesite.server.HNCredentials;
import com.sergebakharev.orangesite.task.HNLoginTask;
    ...
    public void onTaskFinished(int taskCode,
        ...
        if (result != null && result) {
            ...
            if (result != null && !result)
                ...
                messageId = code.equals(com.sergebakharev.orangesite.task.ITaskFinishedHandler.TaskResultCode.NoNetworkConnection) ? R.string.error_login_device_offline
